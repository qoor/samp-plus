...
{
public:
    CShaderAndEntityPair(SShaderInfo* pShaderInfo, ClientEntityBase* pClientEntity, bool bAppendLayers)
    ...
    ClientEntityBase* pClientEntity;
    bool               bAppendLayers;
};
...
public:
    ...
    void GetBestShaderForEntity(ClientEntityBase* pClientEntity, int iEntityType, SShaderInfoLayers& outShaderLayers) const
    {
...
{
public:
    void AppendAdditiveMatch(CSHADERDUMMY* pShaderData, ClientEntityBase* pClientEntity, const SString& strTextureNameMatch, float fShaderPriority,
                             bool bShaderLayered, int iTypeMask, uint uiShaderCreateTime, bool bShaderUsesVertexShader, bool bAppendLayers);
    void AppendSubtractiveMatch(CSHADERDUMMY* pShaderData, ClientEntityBase* pClientEntity, const SString& strTextureNameMatch);
    void InsertTexture(STexInfo* pTexInfo);
    void RemoveTexture(STexInfo* pTexInfo);
    SShaderInfoLayers* GetShaderForTexAndEntity(STexInfo* pTexInfo, ClientEntityBase* pClientEntity, int iEntityType);
...
protected:
    void           CalcShaderForTexAndEntity(SShaderInfoLayers& outShaderLayers, STexNameInfo* pTexNameInfo, ClientEntityBase* pClientEntity, int iEntityType,
                                             bool bSilent);
    ...
    CMatchChannel* GetChannelOnlyUsedBy(SShaderInfo* pShaderInfo, ClientEntityBase* pClientEntity, bool bAppendLayers);
    ...
    STexShaderReplacement* UpdateTexShaderReplacement(STexNameInfo* pTexNameInfo, ClientEntityBase* pClientEntity, int iEntityType);
    ...
    CHashMap<SString, STexNameInfo*>           m_AllTextureList;
    CHashMap<CSHADERDUMMY*, SShaderInfo*>      m_ShaderInfoMap;
    CFastHashSet<ClientEntityBase*>               m_KnownClientEntities;
};
