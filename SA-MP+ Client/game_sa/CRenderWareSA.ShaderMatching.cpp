...
//
//////////////////////////////////////////////////////////////////
void CMatchChannelManager::AppendAdditiveMatch(CSHADERDUMMY* pShaderData, ClientEntityBase* pClientEntity, const SString& strTextureNameMatch,
...
//
//////////////////////////////////////////////////////////////////
void CMatchChannelManager::AppendSubtractiveMatch(CSHADERDUMMY* pShaderData, ClientEntityBase* pClientEntity, const SString& strTextureNameMatch)
{
...
//
//////////////////////////////////////////////////////////////////
STexShaderReplacement* CMatchChannelManager::UpdateTexShaderReplacement(STexNameInfo* pTexNameInfo, ClientEntityBase* pClientEntity, int iEntityType)
{
...
//
//////////////////////////////////////////////////////////////////
SShaderInfoLayers* CMatchChannelManager::GetShaderForTexAndEntity(STexInfo* pTexInfo, ClientEntityBase* pClientEntity, int iEntityType)
{
...
//
//////////////////////////////////////////////////////////////////
void CMatchChannelManager::CalcShaderForTexAndEntity(SShaderInfoLayers& outShaderLayers, STexNameInfo* pTexNameInfo, ClientEntityBase* pClientEntity,
...
//
//////////////////////////////////////////////////////////////////
void CMatchChannelManager::RemoveClientEntityRefs(ClientEntityBase* pClientEntity)
{
    ...
    for (CHashMap<SString, STexNameInfo*>::const_iterator iter = m_AllTextureList.begin(); iter != m_AllTextureList.end(); ++iter)
    {
        MapRemove(iter->second->texEntityShaderMap, pClientEntity);
    }

#ifdef SHADER_DEBUG_CHECKS
    for (CHashSet<CMatchChannel*>::const_iterator iter = m_CreatedChannelList.begin(); iter != m_CreatedChannelList.end(); ++iter)
    {
        CMatchChannel* pChannel = *iter;
        for (CHashSet<CShaderAndEntityPair>::const_iterator iter = pChannel->m_ShaderAndEntityList.begin(); iter != pChannel->m_ShaderAndEntityList.end();
             ++iter)
        {
...
void CMatchChannelManager::RemoveShaderRefs(CSHADERDUMMY* pShaderData)
{
    ...
    for (CHashMap<SString, STexNameInfo*>::const_iterator iter = m_AllTextureList.begin(); iter != m_AllTextureList.end(); ++iter)
    {
        ...
        for (CHashMap<ClientEntityBase*, STexShaderReplacement>::const_iterator iter = pTexNameInfo->texEntityShaderMap.begin();
...
void CMatchChannelManager::RecalcEverything(void)
{
    ...
    CFastHashSet<ClientEntityBase*> removeList = m_KnownClientEntities;
    ...
    for (CFastHashSet<ClientEntityBase*>::iterator iter = removeList.begin(); iter != removeList.end(); ++iter)
    {
...
void CMatchChannelManager::ProcessRematchTexturesQueue(void)
{
    ...
    for (CFastHashSet<CMatchChannel*>::iterator iter = rematchQueue.begin(); iter != rematchQueue.end(); ++iter)
    {
        ...
        for (CHashMap<SString, STexNameInfo*>::iterator iter = m_AllTextureList.begin(); iter != m_AllTextureList.end(); ++iter)
        {
            STexNameInfo* pTexNameInfo = iter->second;
            if (pChannel->m_MatchChain.IsAdditiveMatch(pTexNameInfo->strTextureName))
            {
...
//
//////////////////////////////////////////////////////////////////
CMatchChannel* CMatchChannelManager::GetChannelOnlyUsedBy(SShaderInfo* pShaderInfo, ClientEntityBase* pClientEntity, bool bAppendLayers)
{
...
#ifdef SHADER_DEBUG_CHECKS
    for (CHashMap<CShaderAndEntityPair, CMatchChannel*>::iterator iter = m_ChannelUsageMap.begin(); iter != m_ChannelUsageMap.end(); ++iter)
...
CHashMap<ClientEntityBase*, int> entityIdMap;
CHashMap<SShaderInfo*, int>       shaderInfoIdMap;

int GetEntityId(ClientEntityBase* pClientEntity)
{
...
SString GetDebugTagStr(ClientEntityBase* pClientEntity)
{
    if (!pClientEntity)
        return "E----";
