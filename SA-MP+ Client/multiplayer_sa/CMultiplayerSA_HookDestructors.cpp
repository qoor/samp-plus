...
void _cdecl OnVehicleDestructor(CVehicleSAInterface* pVehicle)
{
    // Tell client to check for things going away
...
#define HOOKSIZE_CVehicleDestructor_US       6
#define HOOKSIZE_CVehicleDestructor_EU       7
//DWORD RETURN_CVehicleDestructor_US = 0x401355;
DWORD RETURN_CVehicleDestructor_US = 0x6E2B47;
...
void CMultiplayerSA::InitHooks_HookDestructors(void)
{
	...
	Debug::write("차량 소멸자 점프 주소: 0x%08x", RETURN_CVehicleDestructor_BOTH);
}
