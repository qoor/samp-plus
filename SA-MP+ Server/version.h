...
// New version info
#define SAMPPLUS_VERSION_MAJOR			0
#define SAMPPLUS_VERSION_MINOR			0
#define SAMPPLUS_VERSION_MAINTENANCE	2
#define SAMPPLUS_VERSION_BUILD			0
...
#define SAMP_PLUS_VERSION (((SAMPPLUS_VERSION_MAJOR) << 8) | ((SAMPPLUS_VERSION_MINOR) << 4) | ((SAMPPLUS_VERSION_MAINTENANCE) << 0))
#define SAMP_PLUS_VERSIONSTRING			QUOTE_DEFINE(SAMPPLUS_VERSION_MAJOR) "." QUOTE_DEFINE(SAMPPLUS_VERSION_MINOR) "." QUOTE_DEFINE(SAMPPLUS_VERSION_MAINTENANCE)

#define SAMP_PLUS_FULL_STRING			"SA-MP+ Server"
